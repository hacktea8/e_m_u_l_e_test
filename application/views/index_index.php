...
?>
	<li class="list">
	<div class="cover_3"><a href="<?php echo $row['url'];?>" target="_blank" onclick=""><img class="lazy"  data-original="<?php echo $showimgapi,$row['cover'];?>" style="width: 100px; height: 100px" alt="<?php echo $row['name'];?>" /><noscript><img src="<?php echo $showimgapi,$row['cover'];?>" alt="<?php echo $row['name'];?>" /></noscript></a></div>
	<div class="cv_title">
	<ul>
...
?>
	...
	<div class="li_img">
	<div class="entry_cover  show_play"><!--[if IE 6]><span class="spacer" style="width:54px;height:74px;"></span><![endif]--><img class="lazy cover_img"  data-original="<?php echo $showimgapi,$row['cover'];?>" alt="<?php echo $row['name'];?>" /><noscript><img src="<?php echo $showimgapi,$row['cover'];?>" alt="<?php echo $row['name'];?>" class="cover_img" /></noscript>
...
?>
	...
	<div class="cover_3"><a
		...
		onclick=""><img class="lazy"  data-original="<?php echo $showimgapi,$row['cover'];?>" style="width: 100px; height: 100px" alt="<?php echo $row['name'];?>" /><noscript><img src="<?php echo $showimgapi,$row['cover'];?>" alt="<?php echo $row['name'];?>" /></noscript></a></div>
	<div class="cv_title">
	<ul>
		<li class="strong"><a
