...
define('CLIENT_ID', '6100084360938795'); // $cleint_id替换成您自己的client id.
define('CLIENT_SECRET', '2abc67908c9c062d6da13ca10fa8ccef'); // $cleint_secret替换成您自己的密码.
define('CLIENT_INDEX', 'emu_hacktea8');
